...
class ReporteApiController extends Controller
{
    ...
    /**
     * Promedio de notas por curso (periodo activo).
     */
    ...
    /**
     * Asistencia mensual agrupada por mes (presente/falta/tardanza).
     */
    ...
    /**
     * Pagos mensuales: cobrados vs pendientes por mes.
     */
    ...
    /**
     * Rendimiento general: distribución de notas por rango (AD/A/B/C).
     */
