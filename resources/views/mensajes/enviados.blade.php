...
<div class="bg-white rounded-xl shadow-sm border overflow-hidden">
    ...
    <a href="{{ route('mensajes.show', $mensaje) }}" class="block p-4 border-b hover:bg-gray-50 transition">
        <div class="flex justify-between items-start">
            <div class="flex-1">
                <span class="text-sm text-gray-500">Para: <strong class="text-gray-800">{{ $mensaje->destinatario->nombre }} {{ $mensaje->destinatario->apellidos }}</strong></span>
    ...
    @empty
    <div class="text-center py-12 text-gray-400">No has enviado mensajes.</div>
    @endforelse
</div>
